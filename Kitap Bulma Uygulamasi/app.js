let kitap1 = { isim: "iki Şehrin Hikayesi", yazar: "Charles Dickens", fiyat: 53, raf: "1.2.RAF" }
let kitap2 = { isim: "Notre Dame'ın Kamburu", yazar: "Victor Hugo", fiyat: 24, raf: "2.5.RAF" }
let kitap3 = { isim: "Madame Bovary", yazar: "Gustave Flaubert", fiyat: 46, raf: "3.4.RAF" }
let kitap4 = { isim: "Gazap Üzümleri", yazar: "John Steinbeck", fiyat: 74, raf: "4.1.RAF" }
let kitap5 = { isim: "Yeraltından Notlar", yazar: "Fyodor Dostoyevski", fiyat: 63, raf: "5.3.RAF" }
...
let raflar = [
    ...
    function rafOlustur() {
        ...
        for (let i = 0; i < raflar.length; i++) {
            for (let j = 0; j < 5; j++) {
                satir += "I " + (raflar[i][j].goster ? raflar[i][j].kod : "---") + " I";
            }
            console.log(satir);
            console.log("-------------------------------");
            satir = "";
